...
module pi4_holes_front() {
    ...
    union() {
        //right rca 
        union() {
            translate([7, y_translation, 25.7])
            rotate([90,0,0])
            cylinder(straight_hole_rim, 5.5, 5.5);   
            
            translate([7, y_translation - straight_hole_rim, 25.7])
            rotate([90,0,0])
        ...
        union() {
            translate([-10, y_translation, 25.7])
            rotate([90,0,0])
            cylinder(straight_hole_rim, 5.5, 5.5);   
            translate([-10, y_translation - straight_hole_rim, 25.7])
            rotate([90,0,0])
            cylinder(2.5-straight_hole_rim+0.1, 5.5, 5.5+extra);
        ...
        //minijack    
       union() {
           translate([-27.1, y_translation, 20])
            rotate([90,0,0])
            cylinder(straight_hole_rim, 4.5, 4.5);
            translate([-27.1, y_translation - straight_hole_rim, 20])
            rotate([90,0,0])
